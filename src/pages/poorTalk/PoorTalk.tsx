...
function PoorTalk() {
  ...
  // 다른 유저 프로필(마이페이지) 조회
  const usersProfileHandler = (userId: undefined | any) => {
  ...
  // 유저 정보 받아오기
  const { data: dataUsersProfile } = useQuery('getUser', getUsersProfile);
    ...
    <div className="currentBackGround">
      ...
      {modalOpen && (
        <UsersProfilePage
          ...
          dataUsersProfile={dataUsersProfile}
        />
      )}
                      ...
                      <div className="myChat">
                        {message.image ? (
                          ...
                          <div>
                            ...
                            {/* <button onClick={showModal}>Modal 1</button> */}
                          </div>
                        )}
                      </div>
                      <div className="nowTime1">
                        {message.date.slice(13, -3)}
                      </div>
                    </>
                  ) : (
                    // 다른 사용자가 보낸 메시지인 경우
